...
function LifeGoalsApp() {
  ...
  const [activeTab, setActiveTab] = useState<"goals" | "study" | "projects" | "daily-todos" | "milestones">("goals")
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 p-4">
      <div className="max-w-7xl mx-auto">
        {/* Header */}
        <div className="mb-8">
          <h1 className="text-4xl font-bold text-gray-900 mb-2">Life Goals & Productivity Suite</h1>
          <p className="text-gray-600">
            Track your dreams, achieve your goals, manage studies, complete projects, and celebrate milestones
          </p>
        </div>
        ...
        <Tabs
          value={activeTab}
          onValueChange={(value) =>
            setActiveTab(value as "goals" | "study" | "projects" | "daily-todos" | "milestones")
          }
          className="w-full"
        >
          <TabsList className="grid w-full grid-cols-5 mb-8">
            ...
            <TabsTrigger value="daily-todos" className="flex items-center gap-2">
